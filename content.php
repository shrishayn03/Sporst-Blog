...
?>
				...
				<div class="fakeimg well" style="margin-top:-7px;"><a href="full_content.php?postid=<?php echo $Post_id; ?>"><center><img src="admin/images/<?php echo $Post_image; ?>" height="70" width="200"></a> <br><br><h5><b><a href="full_content.php?postid=<?php echo $Post_id; ?>"><?PHP echo $Post_title;?></a></b></h5></center></div><br>
			<?php } ?>			
				</div>
