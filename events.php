...
?>
  ...
  <center><a  href="event_details.php?eventid=<?php echo $Event_id; ?>"><img src="admin/images/<?php echo $event_image; ?>" style="height:160px; width:70%;"></a></center>
    <h3> <a  href="event_details.php?eventid=<?php echo $Event_id; ?>"><?php echo $event_name; ?></a></h3>
    <p><?php echo substr($event_details,0,80); ?><a  href="event_details.php?eventid=<?php echo $Event_id; ?>"> <font size="2"><b>READ MORE </b></font><span class="right"></span><span class="right"></span><span class="right"></span></a></p>
  </div>
